...
if __name__=='__main__':
    ...
    """
    data = torch.randn(5500, 5)
    labels = torch.randint(0, 2, (5500, 3))
    # print(labels)
    labels_DF = pd.DataFrame(labels, columns=['MCQ160B', 'MCQ160C', 'MCQ160D'])
    data_DF = pd.DataFrame(data, columns=['1','2','3','4','5'])
    # X, y = create_dataset()
    # print(Counter(y))
    # print(X)#Creating a Dataframe
    X_sub, y_sub = get_minority_instace(data_DF, labels_DF)   #Getting minority instance of that datframe
    # print(y_sub)
